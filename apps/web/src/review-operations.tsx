...
export function ReviewOperationsPanel({ visible = true, directOnly = false }: { visible?: boolean; directOnly?: boolean }) {
  ...
  const items = [...active, ...recent].filter((row) => !directOnly || row.deliveryMode === 'DIRECT_DIRECTORY');
